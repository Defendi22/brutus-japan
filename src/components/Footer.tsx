    ...
    <footer className="bg-gray-900 text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-green-500 font-bold uppercase tracking-widest leading-none">Vegetables Japan</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              ...
              <li><a href="#catalogo" className="hover:text-green-500 transition-colors">Produtos</a></li>
              <li><a href="#" className="hover:text-green-500 transition-colors">Como Comprar</a></li>
              <li><a href="#" className="hover:text-green-500 transition-colors">Dúvidas Frequentes</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input 
                ...
                className="bg-gray-800 border-none rounded-lg px-4 py-2 w-full text-sm focus:ring-2 focus:ring-green-500 outline-none"
              />
              <button className="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm font-bold transition-colors">
                Ok
              </button>
            </form>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-center text-gray-500 text-xs">
          <p>© {new Date().getFullYear()} Brutus Vegetables Japan. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
