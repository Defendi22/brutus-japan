          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-amber-500 font-bold uppercase tracking-widest leading-none">Vegetables Japan</p>
              </div>
            </div>
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input 
                ...
                className="bg-gray-800 border-none rounded-lg px-4 py-2 w-full text-sm focus:ring-2 focus:ring-amber-500 outline-none"
              />
